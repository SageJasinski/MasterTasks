...
public class AddingaTask {
    ...
    public void addingaTask() {
        ...
        ViewInteraction textInputEditText = onView(
                allOf(withId(R.id.add_task_input),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction textInputEditText2 = onView(
                allOf(withId(R.id.task_add_description_input),
                        childAtPosition(
                                childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textInputEditText2.perform(replaceText("hello"), closeSoftKeyboard());

        ViewInteraction materialButton2 = onView(
                allOf(withId(R.id.task_add_butt_input), withText("Add Task"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
